...
#CNFM - CNFM of message
#STRT - START program, parms: mac address, server sends CNFM
#SKEY - send rsa key, client sends CNFM if he got the key
#CURE - send private key, parms: mac address, and decrypet all files, only if locked is false, you have to switch it using the db.py
DEBUG = True
